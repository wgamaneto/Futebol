...
CAST(SUM(CASE WHEN m.home_team_goals > m.away_team_goals THEN 3 ELSE 0 END) AS UNSIGNED) +
CAST(SUM(CASE WHEN m.home_team_goals = m.away_team_goals THEN 1 ELSE 0 END) AS UNSIGNED)
  AS totalPoints,
